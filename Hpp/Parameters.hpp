class Params {
    ...
    class MecArmPb //15
    {
        ...
        texts[] = {
            "0 % chance Heavy Armor + Rewards disabled",
            "25 % chance",
            "50 % chance",
            "75 % chance",
            "100 % chance"
    ...
    class EnableEnemyAir //19
    {
        ...
        texts[] = {
            ...
            "A3 Helis Only",
            "A3 Fixed Wing Only",
            "A3 Helis and A3 Fixed Wing",
            "Moded Helis Only",
            "Moded Fixed Wing Only",
            "Moded Helis and Moded Fixed Wing"
        };
        default = 3;
    };
