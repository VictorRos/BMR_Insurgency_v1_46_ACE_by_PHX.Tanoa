...
JIG_EX_Chopper_Type	= 	["B_CTRG_Heli_Transport_01_tropic_F", "B_Heli_Transport_01_F", "B_Heli_Transport_03_F"]; // Desired Evac Chopper classname in quotes and array.
...
JIG_EX_Smoke_Color = 	"SmokeShellGreen";				// Possible Smoke colors classname in quotes goes here, ie: "SmokeShellOrange","SmokeShellBlue","SmokeShellPurple","SmokeShellGreen","SmokeShellRed","SmokeShell".
...
JIG_EX_Group_Dis	=	200;							// Ungroup group members beyond range of Evac Caller.//Chopper will not Leave Evac LZ until all group members in this range are in chopper
JIG_EX_AmbRadio		=	false;							// Ambient Heli Radio Chatter. Set true to enable. Set false to disable.
JIG_EX_Random_Type	=	true;							// Select random Heli Type from JIG_EX_Chopper_Type. If False, First Vehicle in array JIG_EX_Chopper_Type is chosen. Example: JIG_EX_Chopper_Type = ["B_Heli_Transport_01_camo_F","CH49_Mohawk_FG"];
