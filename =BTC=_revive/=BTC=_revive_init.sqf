...
switch (INS_p_rev) do
{
	...
	{
		BTC_who_can_revive = ["Man"];
		BTC_objects_actions_west = [INS_flag,INS_flag_Bala,INS_flag_Saint_Georges,INS_flag_Rochelle,INS_flag_Tanoa,INS_flag_Aeroport,INS_flag_Port];
		BTC_objects_actions_east = [];
		BTC_objects_actions_guer = [];
		BTC_objects_actions_civ  = [];
		if (isServer) then {
...
BTC_respawn_time	= 0;
BTC_active_mobile	= 1;//Active mobile respawn (You have to put in map the vehicle and give it a name. Then you have to add one object per side to move to the mobile (INS_flag,INS_flag_Bala,INS_flag_Saint_Georges,INS_flag_Rochelle,INS_flag_Tanoa,INS_flag_Aeroport,INS_flag_Port) - (1 = yes, 0 = no))
